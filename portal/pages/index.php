...
<section id="page-beneficiaries" class="page-content hidden space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            <h2 class="text-2xl font-bold text-slate-800">Volunteers</h2>
    ...
    <div class="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-xs">
        <p class="text-xs text-slate-500">Volunteer Management Directory loaded.</p>

        <!-- Example Trigger for Delete Modal -->
        <button onclick="openDeleteModal('volunteerDeleteModal', 'John Doe')"
