    ...
    <div class="p-4 space-y-6 overflow-y-auto flex-1 custom-scrollbar">
        ...
        <div>
            ...
            <nav class="space-y-1">
                ...
                <a href="?page=blogs"
                    class="flex items-center gap-3 px-3 py-2.5 rounded-lg <?php if(isset($_GET['page']) && $_GET['page'] === 'blogs') echo 'bg-emerald-50 text-emerald-700'; ?> font-medium text-sm transition-colors">
                    <i class="fa-solid fa-newspaper w-5 text-center"></i>
                    Blog Posts
                </a>
