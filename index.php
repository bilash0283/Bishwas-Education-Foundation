<?php include 'include/header.php'; ?>
        ...
        <section class="relative bg-gradient-to-r lg:px-10 px-4 from-blue-900 to-teal-950 text-white py-20 lg:py-32 overflow-hidden">
            <div
                class="absolute inset-0 opacity-20 bg-[url('https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?auto=format&fit=crop&q=80&w=1200')] bg-cover bg-center">
            </div>
            <div class="container mx-auto px-4 relative z-10 grid md:grid-cols-2 gap-12 items-center lg:mt-[-60px]">
                <div class="space-y-6">
                    <span
                        class="bg-emerald-500/20 text-emerald-300 border border-emerald-500/30 px-4 py-1.5 rounded-full text-sm font-semibold tracking-wider block w-fit">
                        মানবসেবায় একটি বিশ্বাসযোগ্য প্রতিষ্ঠান
                    </span>
                    <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                        জন স্বার্থে, <br><span class="text-emerald-400">বিশ্বাস ও আস্থার</span> সাথে।
                    </h1>
                    <p class="text-gray-300 text-lg leading-relaxed">
                        বিশ্বাস এডুকেশন ফাউন্ডেশন একটি অলাভজনক ও সম্পূর্ণ দাতব্য সংস্থা যা মানুষের কল্যাণ, শিক্ষা বিস্তার, ও
                        দুস্থদের কর্মসংস্থান তৈরিতে নিরলসভাবে কাজ করে যাচ্ছে। আপনার একটি ছোট অনুদান বদলে দিতে পারে একটি
                        অসহায় পরিবারের ভাগ্য।
                    </p>
                    <div class="flex flex-wrap gap-4 pt-2">
                        <a href="#projects"
                            class="bg-emerald-500 hover:bg-emerald-600 text-white font-bold px-8 py-3.5 rounded-xl shadow-lg transition duration-300 transform hover:-translate-y-0.5">
                            আজই শরীক হোন <i class="fa-solid fa-arrow-right ml-2"></i>
                        </a>
                        <a href="#about"
                            class="bg-transparent border-2 border-white/40 hover:border-white hover:bg-white/10 text-white font-bold px-8 py-3.5 rounded-xl transition duration-300">
                            আমাদের লক্ষ্য জানুন
                        </a>
                    </div>
                </div>
                <div class="bg-white/10 backdrop-blur- border border-white/10 p-8 rounded-2xl grid grid-cols-2 gap-6 text-center shadow-2xl">
                    <div class="p-4 bg-white/5 rounded-xl">
                        <h3 class="text-3xl font-bold text-emerald-400">
                            <span class="counter" data-target="1700">০</span>+
                        </h3>
                        <p class="text-sm text-gray-300 mt-1">উপকারভোগী মানুষ</p>
                    </div>

                    <div class="p-4 bg-white/5 rounded-xl">
                        <h3 class="text-3xl font-bold text-emerald-400">
                            <span class="counter" data-target="10">০</span>+
                        </h3>
                        <p class="text-sm text-gray-300 mt-1">সক্রিয় প্রজেক্ট</p>
                    </div>

                    <div class="p-4 bg-white/5 rounded-xl">
                        <h3 class="text-3xl font-bold text-emerald-400">
                            <span class="counter" data-target="100" data-suffix="%">০</span>
                        </h3>
                        <p class="text-sm text-gray-300 mt-1">স্বচ্ছতা ও আমানত</p>
                    </div>

                    <div class="p-4 bg-white/5 rounded-xl">
                        <h3 class="text-3xl font-bold text-emerald-400">
                            <span class="counter" data-target="100">০</span>+
                        </h3>
                        <p class="text-sm text-gray-300 mt-1">নিবন্ধিত ভলান্টিয়ার</p>
                    </div>
                </div>
            </div>
        </section>
